...
class ProductDetailsSummaryFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        this.sold_in.setText(getString(R.string.sell_in, product?.liste_pays))
        this.ingredients.setText(getString(R.string.product_ingredients, product?.liste_ingredients))
        this.substances.setText(getString(R.string.product_substances, product?.liste_substances))
        this.additives.setText(getString(R.string.product_additive, product?.liste_aditifs))
    }
